...
export function Navigation() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 rounded-b-2xl shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
